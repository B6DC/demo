	  ...
	  <div class="container">    
			<a href="post-ad.html">搜索</a>
					...
					<div class="resp-tabs-container hor_1">
						...
						<div>
							<div class="category">
								<div class="category-img" style="hight:100px;width:100px;">
									<h4>${u.bookPhoto}</h4><img src="images/cat1.png" title="image" alt="" />
								</div>
								<div class="category-info" >
									<h2 style="color:blue;">${u.bookName}</h2>
									<h4 style="color:red;">￥${u.bookPrice}</h4>
								</div>
								<div class="header-right">
									<a class="account" href="login.html">加入购物车</a>
								</div>
